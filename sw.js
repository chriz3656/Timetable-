// sw.js
const VERSION = "v6"; // ⬅️ bump this number every time you update
...
const FILES_TO_CACHE = [
  ...
  "https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" // ⬅️ Cache external dependencies
